...
if __name__ == "__main__":
    ...
    with open(output_csv, "a") as output:
        ...
        if os.stat(output_csv).st_size == 0:
            output.write("unique_id,step,reward,steer,gas,brake,true_speed,abs_0,abs_1,abs_2,abs_3,on_grass\n")
        while not quit:
            #generate unique id
            env.reset()
            total_reward = 0.0
            ...
            while True:
                ...
                total_reward += r
                output.write(f"{unique_id},{steps},{r},{a[0]},{a[1]},{a[2]},{env.get_speed():.2f},{env.get_abs_sensors_0():.2f},{env.get_abs_sensors_1():.2f},{env.get_abs_sensors_2():.2f},{env.get_abs_sensors_3():.2f}, {env.get_on_grass()}\n")
